...
using Common.Contracts.Validation;
...
namespace Common.Persistence
{
    ...
    {
        public CommonApplicationDbContext BaseApplicationDbContext { get; init; }
        private bool _disposed;

        public CommonUnitOfWork(CommonApplicationDbContext dbContext)
        {
        ...
        {
            BaseApplicationDbContext.ChangeTracker.Clear();
        }

        public void Reload(IEntityObject entity)
        {
            BaseApplicationDbContext.Entry(entity).Reload();
        }

        public void AddEntityToContext(IEntityObject entity)
        {
            BaseApplicationDbContext.Attach(entity);
            BaseApplicationDbContext.Entry(entity).State = EntityState.Added;
        }

        public bool ContextHasChanges => BaseApplicationDbContext.ChangeTracker.HasChanges();
