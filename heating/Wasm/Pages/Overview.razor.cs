...
namespace Wasm.Pages
{
    public partial class Overview : IAsyncDisposable
    {
        ...
        private readonly Dictionary<string, ActorUiDto> actors = new ();
        private readonly Dictionary<string, SensorWithLastValueUiDto> sensors = new ();
        ...
        protected override async Task OnInitializedAsync()
        {
            ...
            hubConnection.On<FsmTransition>("ReceiveFsmStateChanged", (fsmInfo) =>
            {
